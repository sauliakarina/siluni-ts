  <!-- head -->
        ...
        <div class="content-inner">
          ...
          <div class="alert alert-info alert-dismissible" role="alert">
            ...
            <strong><i class="fa fa-warning"></i> Perhatian!</strong> <p style="font-family: verdana; font-size: 11pt">Grafik dapat ditampilkan untuk pertanyaan jenis pilihan, ganda, dan interval</p>
          </div>
                   <!-- Forms Section-->
          <section class="forms"> 
            <div class="container-fluid">
